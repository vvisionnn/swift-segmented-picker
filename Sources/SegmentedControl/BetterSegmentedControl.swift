...
open class BetterSegmentedControl: UIControl {
	...
	open override var intrinsicContentSize: CGSize {
		...
		let singleSegmentWidth = totalInsetSize + max(
			maxSegmentIntrinsicContentSizeWidth,
			Constants.minimumSegmentIntrinsicContentSizeWidth
		) + segmentPadding
	...
	private func performIndexChange(
		fromPreviousIndex previousIndex: Int,
